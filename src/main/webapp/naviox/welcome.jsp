...
In Test_Razonamiento_B-labels_en.properties:
Test_Razonamiento_B=My application
Test_Razonamiento_B[description]=My application does this and that

In Test_Razonamiento_B-messages_en.properties:
